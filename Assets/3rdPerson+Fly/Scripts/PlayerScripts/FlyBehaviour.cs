...
public class FlyBehaviour : GenericBehaviour
{
	...
	public Animator flybuttonAnim;
	public Animator flyportbuttonAnim;
	...
	public void flying()
    {
		...
		if (fly)
		{
			// Register this behaviour.
			behaviourManager.RegisterBehaviour(this.behaviourCode);
			flybuttonAnim.SetBool("flying", true);
			flyportbuttonAnim.SetBool("flyingport", true);
		}
		else
		{
			// Set collider direction to vertical.
			...
			// Set camera default offset.
			behaviourManager.GetCamScript.ResetTargetOffsets();
			flybuttonAnim.SetBool("flying", false);
			flyportbuttonAnim.SetBool("flyingport", false);
			// Unregister this behaviour and set current behaviour to the default one.
			behaviourManager.UnregisterBehaviour(this.behaviourCode);
		}
	}
